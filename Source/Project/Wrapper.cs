...
namespace RegionOrebroLan.Abstractions
{
	public abstract class Wrapper : IWrapper
	{
		...
		{
			this.WrappedInstance = wrappedInstance ?? throw new ArgumentNullException(wrappedInstanceParameterName ?? nameof(wrappedInstance));
		}
